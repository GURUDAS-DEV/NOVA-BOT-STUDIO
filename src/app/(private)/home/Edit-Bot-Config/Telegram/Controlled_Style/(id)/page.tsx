...
const EditControlledStyleTelegramBotPage = () => {
    ...
    const [formData, setFormData] = useState<FormData>({
        botType: "Controlled Style Telegram Bot",
        tone: "Professional",
        verbosity: "Balanced",
    ...
    const getBotConfig = async (botId: string) => {
        try {
            ...
            setFormData({
                botType: data?.config?.config?.botType || "Controlled Style Telegram Bot",
            ...
            console.error("Error fetching controlled style telegram bot configuration:", e);
            setBotNotFound(true);
        } finally {
            setLoading(false);
        }
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            console.error("Error saving controlled style telegram config:", error);
        } finally {
            setSaving(false);
        }
    };
    ...
    const sections = [
        ...
        },
        {
            ...
            description: "Controlled bot behavior and service details",
        ...
        },
        {
            ...
            description: "Q&A pairs for controlled bot training",
            ...
            <div className="max-w-6xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2 font-outfit">
                        {botName} - Controlled Style Telegram Bot
                    </p>
                </div>
                                ...
                                {editingSection === "telegramCredentials" && (
                                    <div className="space-y-4">
                                        ...
                                        {tempFormData.tokenValidationMessage && (
                                            <div
                                                className={`p-3 rounded-lg border ${tempFormData.tokenStatus === "valid"
                                                        ? "border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-950/20"
                                                        : "border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-950/20"
                                                    }`}
                                            >
                                                <p
                                                    className={`text-sm font-outfit ${tempFormData.tokenStatus === "valid"
                                        ...
                                        <Button
                                            ...
                                            className={`w-full text-white font-outfit ${tempFormData.tokenStatus === "valid"
                                ...
                                {editingSection === "detailedDescription" && (
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span
                                                className={`text-sm font-medium ${tempFormData.detailedDescription.length >= 100
                                        ...
                                        <Textarea
                                            placeholder="Describe exactly how your controlled bot should behave, what topics it must strictly cover, and its interaction boundaries..."
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    {sections.map((section) => (
                        <div
                            ...
                            className={`group relative rounded-xl p-6 border-2 transition-all duration-200 ${section.locked
                        ...
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div
                                    className={`p-3 rounded-lg transition-colors ${section.locked
...
export default EditControlledStyleTelegramBotPage;
