  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          What type of server will this bot be used on?
        </p>
      </div>
...
export default function CreateDiscordBotWizard() {
  const params = useParams();
  const searchParams = useSearchParams();
  const botId = (params.id as string) || searchParams.get("id") || "";
  ...
  const sendDiscordBotConfig = async (): Promise<void> => {
    try{
      setLoading(true);
        ...
        <div className="w-full font-outfit">
          ...
          <h2 className="text-2xl  text-gray-900 dark:text-white mb-2">
            {botName
              ...
              : "Creating a New Discord Free-Style Bot"}
          </h2>
        </div>
